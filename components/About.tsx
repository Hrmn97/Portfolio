...
const About = (props: Props) => {
  return (
    ...
    className='h-screen relative flex flex-col text-center md:text-left md:flex-row max-x-7xl px-10 justify-evenly mx-auto items-center '>
        <h3 className='absolute top-24 tracking-[20px] text-amber-400 text-2xl uppercase'>About</h3>
        <motion.img 
        initial={{
            x: -200,
            opacity:0
        ...
        <div className='space-y-10 px-0 md:px-10'>
            <h4 className='text-4xl font-semibold '>My <span className='underline decoration-amber-400'>story</span></h4>
